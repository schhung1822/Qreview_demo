    ...
    <div className="flex items-center border-t border-gray-3 py-5 px-10">
      <div className="min-w-[83px]">
        <button
          ...
          className="flex items-center justify-center rounded-lg max-w-[38px] w-full h-9.5 bg-background dark:bg-surface border border-gray-3 dark:border-dark-3 ease-out duration-200 hover:bg-red-light-6 dark:hover:bg-red/20 hover:border-red-light-4 dark:hover:border-red hover:text-red"
        >
          <svg
      ...
      <div className="min-w-[387px]">
        <div className="flex items-center justify-between gap-5">
          <div className="w-full flex items-center gap-5.5">
            <div className="flex items-center justify-center rounded-[5px] bg-background dark:bg-surface max-w-[80px] w-full h-17.5">
              <Image src={item.imgs?.thumbnails[0]} alt="product" width={200} height={200} />
            </div>

            <div>
              <h3 className="text-dark dark:text-foreground ease-out duration-200 hover:text-blue">
                <a href="#"> {item.title} </a>
              </h3>
            </div>
          </div>
      ...
      <div className="min-w-[205px]">
        <p className="text-dark dark:text-foreground">${item.discountedPrice}</p>
      </div>
      ...
      <div className="min-w-[150px] flex justify-end">
        <button
          ...
          className="inline-flex text-foreground dark:text-text-primary hover:text-white bg-background dark:bg-surface border border-gray-3 dark:border-dark-3 py-2.5 px-6 rounded-md ease-out duration-200 hover:bg-blue hover:border-gray-3"
        >
          Add to Cart
        </button>
      </div>
