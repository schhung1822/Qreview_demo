...
const Signin = () => {
  return (
    <>
      ...
      <section className="overflow-hidden py-20 border-t border-gray-3">
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="max-w-[570px] w-full mx-auto rounded-xl bg-surface dark:bg-surface shadow-1 p-4 sm:p-7.5 xl:p-11">
            <div className="text-center mb-11">
              <h2 className="font-semibold text-xl sm:text-2xl xl:text-heading-5 text-foreground mb-1.5">
                Đăng nhập tài khoản
              </h2>
            ...
            <div>
              <form>
                ...
                <a
                  href="#"
                  className="block text-center text-foreground mt-4.5 ease-out duration-200 hover:text-dark"
                >
                  Quên mật khẩu?
                </a>
                ...
                <span className="relative z-1 block font-medium text-center mt-4.5">
                  ...
                  <span className="inline-block px-3 bg-white dark:bg-surface">Hoặc</span>
                </span>

                <div className="flex flex-col gap-4.5 mt-4.5">
                  <button className="flex justify-center items-center gap-3.5 rounded-lg border dark:text-dark border-gray-3 bg-gray-1 p-3 ease-out duration-200 hover:bg-gray-2">
                    <svg
                      width="20"
                      height="20"
                      viewBox="0 0 20 20"
                ...
                <p className="text-center mt-6">
                  ...
                  <Link
                    href="/signup"
                    className="text-foreground ease-out duration-200 hover:text-blue pl-2"
                  >
                    Đăng ký ngay!
                  </Link>
                </p>
